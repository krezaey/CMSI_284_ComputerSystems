...
main:
            ...
            jmp     sub_handler ; jump to the addition section for the actual calculation to occur

sub_handler:  
            mov     rax, r12    ; move the first argument into the rax
            sub     rax, r13    ; subtract the r12 and r13 summands
            mov     r14, rax    ; store the difference in r14
...
format_result:
            ...
            mov     rsi, r12    ; first number to be subtracted into first %d
            mov     rdx, r13    ; second number to be subtracted into second %d
            mov     rcx, r14    ; final difference result into third %d    
